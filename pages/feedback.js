...
const CONTRIBUTORS = [
  {
    name: "Senior Brother Léo",
    role: "Raw Source Provider",
    desc: "For venturing into the chaotic void to bring us raw scriptures.",
  },
  {
    name: "Daoist Reader Optayy",
    role: "Community Pillar",
    desc: "For moderating the discussion pavilion with an iron fist.",
  },
  {
    name: "God slayer",
    role: "Translation Editor",
    desc: "For polishing the Dao of English and fixing sect terminology.",
  },
];
...
export default function Feedback() {
  ...
  useEffect(() => {
    // Ensure code runs only in the browser
      ...
      const savedEmail = localStorage.getItem("localEmail");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(
          data.error || "Transmission disrupted by heavenly tribulation.",
        );
      }
      console.log(formData);

      localStorage.setItem("localName", formData.name);
      localStorage.setItem("localEmail", formData.email);
      setSubmitted(true);
      setFormData((prev) => ({
        ...prev,
        message: "",
  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-12 bg-dark-bg">
        <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12 animate-fadeIn px-4 overflow-y-auto">
          {" "}
          {/* Added overflow + responsive space */}
          {/* Introduction */}
          <div className="text-center space-y-4">
            <h1 className="text-3xl md:text-4xl font-bold text-white">
              Sect Support & Hall of Fame
            </h1>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Encountered a demonic bug in the system? Wish to offer tribute or
              suggestions for the sect's growth? Transmit your spirit message
              below.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
            ...
            <div className="bg-dark-card rounded-xl border border-dark-border p-6 shadow-lg">
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center text-center space-y-4 bg-brand-900/10 rounded-lg border border-brand-500/30 p-6">
                  {" "}
                  {/* Removed h-64 */}
                  ...
                  <p className="text-gray-400 text-sm">
                    Your message has been received by the sect elders. We will
                    meditate on your feedback.
                  </p>
                  <button
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Translation Issue">
                          Translation Issue
                        </option>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-indigo-900/50 to-brand-900/50 rounded-xl border border-brand-500/30 p-6">
                ...
                <p className="text-sm text-gray-300 mb-6">
                  The Celestial Novels platform would not exist without the
                  contributions of these illustrious seniors. May their
                  cultivation journey be smooth and devoid of heart demons.
                </p>
                <div className="space-y-3">
                  {CONTRIBUTORS.map((c, i) => (
                    <div
                      key={i}
                      className="bg-dark-bg/60 rounded-lg p-3 flex items-start gap-3 border border-dark-border hover:border-brand-500/50 transition-colors"
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs font-semibold text-brand-300 mb-0.5">
                          {c.role}
                        </div>
