...
export default function TopBar({ onOpenChapters, onSearch, initialSearch = '', isHidden = false }) {
    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3 h-14">
          ...
          <form onSubmit={handleSubmit} className="flex-1 hidden sm:block">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/bookmarks" className="hidden sm:inline-block text-sm text-blue-600">
              Bookmarks
            </Link>
          </div>
        </div>
